...
class MigrationsTableMap extends TableMap
{
     ...
     */
    const COL_VERSION = 'migrations.version';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Version', ),
        self::TYPE_CAMELNAME     => array('version', ),
        self::TYPE_COLNAME       => array(MigrationsTableMap::COL_VERSION, ),
        self::TYPE_FIELDNAME     => array('version', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Version' => 0, ),
        self::TYPE_CAMELNAME     => array('version' => 0, ),
        self::TYPE_COLNAME       => array(MigrationsTableMap::COL_VERSION => 0, ),
        self::TYPE_FIELDNAME     => array('version' => 0, ),
        self::TYPE_NUM           => array(0, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(MigrationsTableMap::COL_VERSION);
        } else {
