...
class EsUsersTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdUser', 'Name', 'Lastname', 'Username', 'Email', 'Address', 'Password', 'Birthdate', 'Age', 'Carnet', 'Sexo', 'Phone1', 'Phone2', 'Cellphone1', 'Cellphone2', 'IdsFiles', 'IdCoverPicture', 'IdCity', 'IdProvincia', 'IdRole', 'SigninMethod', 'Uid', 'ChangeCount', 'Status', 'DateModified', 'DateCreated', ),
        self::TYPE_CAMELNAME     => array('idUser', 'name', 'lastname', 'username', 'email', 'address', 'password', 'birthdate', 'age', 'carnet', 'sexo', 'phone1', 'phone2', 'cellphone1', 'cellphone2', 'idsFiles', 'idCoverPicture', 'idCity', 'idProvincia', 'idRole', 'signinMethod', 'uid', 'changeCount', 'status', 'dateModified', 'dateCreated', ),
        self::TYPE_COLNAME       => array(EsUsersTableMap::COL_ID_USER, EsUsersTableMap::COL_NAME, EsUsersTableMap::COL_LASTNAME, EsUsersTableMap::COL_USERNAME, EsUsersTableMap::COL_EMAIL, EsUsersTableMap::COL_ADDRESS, EsUsersTableMap::COL_PASSWORD, EsUsersTableMap::COL_BIRTHDATE, EsUsersTableMap::COL_AGE, EsUsersTableMap::COL_CARNET, EsUsersTableMap::COL_SEXO, EsUsersTableMap::COL_PHONE_1, EsUsersTableMap::COL_PHONE_2, EsUsersTableMap::COL_CELLPHONE_1, EsUsersTableMap::COL_CELLPHONE_2, EsUsersTableMap::COL_IDS_FILES, EsUsersTableMap::COL_ID_COVER_PICTURE, EsUsersTableMap::COL_ID_CITY, EsUsersTableMap::COL_ID_PROVINCIA, EsUsersTableMap::COL_ID_ROLE, EsUsersTableMap::COL_SIGNIN_METHOD, EsUsersTableMap::COL_UID, EsUsersTableMap::COL_CHANGE_COUNT, EsUsersTableMap::COL_STATUS, EsUsersTableMap::COL_DATE_MODIFIED, EsUsersTableMap::COL_DATE_CREATED, ),
        self::TYPE_FIELDNAME     => array('id_user', 'name', 'lastname', 'username', 'email', 'address', 'password', 'birthdate', 'age', 'carnet', 'sexo', 'phone_1', 'phone_2', 'cellphone_1', 'cellphone_2', 'ids_files', 'id_cover_picture', 'id_city', 'id_provincia', 'id_role', 'signin_method', 'uid', 'change_count', 'status', 'date_modified', 'date_created', ),
