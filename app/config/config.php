...
|
*/
$config['encryption_key'] = '8aP118e*4500343+256Ic03e50dO87t3';
...
$config['csrf_token_name'] = 'ctn_app';
$config['csrf_cookie_name'] = 'ccn_app';
...
|7
| proy_name = 'defensor';
| proy_current_path = output: /myproject/index.php
| proy_hostname = output: localhost
| proy_protocol = strtolower(substr($_SERVER["SERVER_PROTOCOL"],0,5))=='https'?'https':'http';
*/
